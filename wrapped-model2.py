...
def predict_sentiment(sentence, model, stoi_dict, label_itos):
    ...
    return sentence, sentiment, probs, ' '.join(tokenized), indexed
...
for i, item in enumerate(data):
    ...
    _, predicted_sentiment, probabilities, transfered_sentence, indexes_available = \
        predict_sentiment(text, model, stoi_dict, label_itos)
